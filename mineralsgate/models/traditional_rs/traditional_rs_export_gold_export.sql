SELECT
  ...
  CONCAT('https://mineralsgate.com/app/managers/gold_travel/appmovegold/',"public"."gold_travel_appmovegold"."id",'/change/') as "link"
...
WHERE "public"."gold_travel_appmovegold"."form_type" = 1
