SELECT
  ...
  CONCAT('https://mineralsgate.com/app/managers/gold_travel/appmovegoldexportsilver/',"public"."gold_travel_appmovegold"."id",'/change/') as "link"
...
WHERE
  "public"."gold_travel_appmovegold"."form_type" = 3
  AND "public"."gold_travel_appmovegold"."source_state_id" = 10
